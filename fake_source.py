...
def fake_source(mev, mvp, coeff=None, thickness=0, method='normal'):
	...
	for an 'ideal' source with a very narrow energy range. This range is
    centred at (0.7 * mvp) so that it is approximately at the peak of a normal
    source using the same mvp value."""
